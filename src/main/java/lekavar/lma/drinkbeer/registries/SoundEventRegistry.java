...
public class SoundEventRegistry {
    public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, DrinkBeer.MODID);
    ...
    public static final RegistryObject<SoundEvent> LEKAS_CALL_BELL_TINKLING = register("lekas_call_bell_tinkling");
