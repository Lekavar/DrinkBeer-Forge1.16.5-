...
public class BeerBarrelContainer extends Container {
    ...
    public BeerBarrelContainer(int id, IInventory brewingSpace, IIntArray syncData, PlayerInventory playerInventory, BeerBarrelTileEntity beerBarrelTileEntity) {
        super(ContainerTypeRegistry.BEER_BARREL_CONTAINER.get(), id);
    ...
    static class OutputSlot extends Slot {
        ...
        public ItemStack onTake(PlayerEntity playerEntity, ItemStack itemStack) {
            playerEntity.level.playSound((PlayerEntity) null, beerBarrelTileEntity.getBlockPos(), ((BeerItem) itemStack.getItem()).getBeer().getPouringSound().get(), SoundCategory.BLOCKS, 1.0F, 1.0F);
